  ...
  implements Lifecycle
{
  ...
  public RedisSessionManager()
  {
    ...
    this.log = LogFactory.getLog(RedisSessionManager.class);
    ...
    try
    {
      ...
      if (data == null) {
        ...
        if (this.log.isTraceEnabled()) {
          ...
          for (i$ = Collections.list(session.getAttributeNames()).iterator(); i$.hasNext(); ) { Object name = (String)i$.next();
            this.log.trace("  " + name);
          }
        }
      }
  ...
  public void save(Session session) throws IOException
  {
    ...
    try
    {
      ...
      if (this.log.isTraceEnabled()) {
        ...
        for (Iterator i$ = Collections.list(redisSession.getAttributeNames()).iterator(); i$.hasNext(); ) { Object name = (String)i$.next();
          this.log.trace("  " + name);
        }
      }
